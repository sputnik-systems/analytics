...
```python
query_text = """--sql
    ALTER TABLE db1.companies_dir_partner_ch DELETE WHERE report_date = '2025-07-17'
    """
...
```python
query_text = """--sql
    DROP TABLE db1.companies_dir_partner_mv
    """
...
```python
query_text = """--sql
    DROP TABLE db1.companies_dir_partner_ch
    """
...
```python
query_text = """
SYSTEM REFRESH VIEW db1.companies_dir_partner_mv
"""
